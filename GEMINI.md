...
- **Cells 22–53**: **EDA** — 30 Plotly charts numbered 1–30 (salary distributions, experience trends, skills, seasonal hiring, entry-level-filtered views, etc.)
- **Cells 54–61**: **ML** — 6 models (salary prediction, experience classification, urgency, remote type, growth analysis, PyTorch Integrated Gradients)
- **Cells 62–68**: **Deep Learning** — entity embeddings, autoencoder anomaly detection
- **Cells 69-75**: **Forecasting**
